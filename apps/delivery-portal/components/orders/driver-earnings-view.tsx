  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        ...
        className="rounded-[20px] bg-emerald-600 p-5 text-white shadow-lg shadow-emerald-100"
      >
      ...
      <div className="grid grid-cols-2 gap-3">
        <motion.div
          ...
          className="rounded-[16px] border border-amber-100 bg-amber-50 p-4"
        >
      ...
      <motion.div
        ...
        className="rounded-[16px] border border-slate-200 bg-white p-4 flex items-center gap-3"
      >
