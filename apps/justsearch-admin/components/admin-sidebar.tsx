...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      <aside className={`fixed left-0 top-0 z-40 h-full w-64 bg-slate-900 text-white transition-transform md:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
