    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500">Monthly revenue, users, and orders</p>
        </div>
      </div>
      <div className="h-56">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
            <defs>
              <linearGradient id={DASHBOARD_CHART_GRADIENT_ID} x1="0" y1="0" x2="0" y2="1">
            ...
            />
            <Area type="monotone" dataKey="revenue" stroke="#6366f1" strokeWidth={2} fill={`url(#${DASHBOARD_CHART_GRADIENT_ID})`} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
