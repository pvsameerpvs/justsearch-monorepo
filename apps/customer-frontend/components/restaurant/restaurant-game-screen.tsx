                    ...
                    <div className="flex flex-1 flex-col items-center justify-center py-8 text-center">
                        ...
                        <div className="mb-12">
                            <button 
                                ...
                                className="group relative flex h-22 w-48 items-center justify-center overflow-hidden rounded-[30px] bg-white shadow-[0_12px_24px_-8px_rgba(0,0,0,0.4),0_8px_0_#cbd5e1] active:translate-y-1 active:shadow-none transition-all"
                            >
                                <span className="relative z-10 text-4xl font-black italic tracking-tighter text-[#1e293b]">PLAY</span>
