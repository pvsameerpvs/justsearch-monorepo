  ...
  return (
    <Surface className="rounded-[32px] border-white/70 bg-[linear-gradient(145deg,rgb(var(--brand-soft)/0.35),rgba(255,255,255,0.92),rgb(var(--accent-soft)/0.35))] p-6 sm:p-8 shadow-xl shadow-black/5 ring-1 ring-black/[0.03]">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-1 space-y-1 text-[11px] font-bold text-[rgb(var(--muted))] uppercase tracking-tight">
            ...
            {isRegistered && user ? (
              ...
              <button type="button" onClick={openModal} className="text-left font-black text-[rgb(var(--brand))] hover:underline">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        <Link href="/eat-play/profile" className="group relative overflow-hidden rounded-[26px] border border-white bg-white/60 p-5 shadow-sm ring-1 ring-black/[0.02] transition-all hover:bg-white">
          <p className="text-[10px] font-black uppercase tracking-widest text-[rgb(var(--muted))]">Wallet Balance</p>
        ...
        <Link href="/eat-play/profile" className="flex items-center justify-between rounded-[22px] border border-[rgb(var(--border)/0.9)] bg-white/80 p-4 transition-all hover:bg-white">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-widest text-[rgb(var(--muted))]">Play</p>
            <p className="mt-1 text-sm font-semibold text-[rgb(var(--ink))]">Earn more points</p>
          </div>
