    ...
    games: [
      {
        id: 'spin-wheel',
        name: 'Spin & Win',
        description: 'Spin the wheel to win instant points!',
        icon: '🎡',
        coverImageUrl: '/games/spin-wheel.svg',
        prize: 'Up to 5000 points',
        accessLevel: 'public',
        isAvailable: true,
      },
      {
        id: 'scratch-card',
        name: 'Lucky Scratch',
        description: 'Scratch to reveal hidden point rewards.',
        icon: '🎫',
        coverImageUrl: '/games/scratch-card.svg',
      ...
      },
      {
        id: 'vex-8',
        name: 'Vex 8',
        description: 'The latest and greatest in the Vex series! New levels and mechanics.',
        icon: '🤸',
        coverImageUrl: '/games/vex-8.svg',
        prize: 'Up to 2500 points',
        accessLevel: 'public',
        isAvailable: true,
        tag: 'HOT',
        embedId: '949009d40a2846f89f887de2285d6c28',
      },
      {
        id: 'vex-7',
        name: 'Vex 7',
        description: 'Classic Vex platforming with more puzzles and obstacles.',
        icon: '🏃',
        coverImageUrl: '/games/vex-7.svg',
        prize: 'Up to 2000 points',
        accessLevel: 'public',
        isAvailable: true,
        tag: 'TOP RATED',
        embedId: '0c454c9562d249d28ba3a2b50564042c',
      },
      {
        id: 'vex-6',
        name: 'Vex 6',
        description: 'Take your skills to the next level in this legendary sequel.',
        icon: '🧗',
        coverImageUrl: '/games/vex-6.svg',
        prize: 'Up to 1500 points',
        accessLevel: 'public',
        isAvailable: true,
        embedId: '4925e12574364121a48c61c35f649c36',
      },
      {
        id: 'vex-runner',
      ...
      },
      {
        id: 'vex-challenges',
        name: 'Vex Challenges',
        description: 'Bite-sized levels for the ultimate test of speed!',
        icon: '⚡',
        coverImageUrl: '/games/vex-challenges.svg',
        prize: 'Up to 3000 points',
        accessLevel: 'public',
        isAvailable: true,
        tag: 'PRO',
        embedId: 'b657d0d7da2e46919d24862aa1f3e758',
      },
    ],
    reviews: [
      {
