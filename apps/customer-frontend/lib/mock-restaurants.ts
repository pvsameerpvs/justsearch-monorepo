    ...
    games: [
      {
        id: 'spin-wheel',
        name: 'Spin the Wheel',
        description: 'Spin for points, offers, or unlock a scratch card',
        icon: '🎰',
        coverImageUrl: '/games/spin-wheel.svg',
        prize: 'Up to 120 points',
        accessLevel: 'session_required',
        isAvailable: true,
      },
      {
        id: 'scratch-card',
        name: 'Scratch Card',
        description: 'Reveal an instant reward after check-in',
        icon: '🎟️',
        coverImageUrl: '/games/scratch-card.svg',
        prize: 'Offer or bonus points',
        accessLevel: 'session_required',
        isAvailable: true,
      },
      {
        id: 'tap-challenge',
        name: 'Tap Challenge',
        description: 'Tap fast to build a streak and earn combo bonus',
        icon: '👆',
        coverImageUrl: '/games/tap-challenge.svg',
        prize: 'Combo points',
      ...
      },
      {
        id: 'quick-quiz',
        name: 'Quick Quiz',
        description: 'Answer a few questions and unlock a surprise reward',
        icon: '🧠',
        coverImageUrl: '/games/quick-quiz.svg',
        prize: 'Instant reward',
        accessLevel: 'login_required',
        isAvailable: true,
      },
    ],
