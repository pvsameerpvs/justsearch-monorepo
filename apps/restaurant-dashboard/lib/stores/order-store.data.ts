...
import type { OrderStatus, DashboardOrder, TimelineEvent } from "./order-store";
...
export const BASE_TIME = new Date("2026-05-13T14:00:00.000Z").getTime();
export const timeAgo = (min: number) => new Date(BASE_TIME - min * 60000).toISOString();
