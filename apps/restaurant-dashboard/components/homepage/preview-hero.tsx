...
export function PreviewHero({ restaurant }: PreviewHeroProps) {
  ...
  return (
    ...
    >
      <div className="mx-auto mb-4 shadow-[0_18px_60px_rgba(15,23,42,0.15)] ring-1 ring-[rgb(${t.border}/0.28)] overflow-hidden border border-[rgb(${t.cardBorder}/0.9)] bg-[rgb(${t.cardSurface}/0.96)] h-28 w-28 rounded-[32px]">
        {restaurant.logoUrl ? (
