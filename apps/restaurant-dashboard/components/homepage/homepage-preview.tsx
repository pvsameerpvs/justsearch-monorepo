  ...
  const cards = [
    {
      ...
      bg: `linear-gradient(160deg,rgba(${t.brandSoft},0.45),rgba(255,255,255,0.92))`,
      iconBg: `rgb(${t.brandSoft})`,
    },
    {
      title: "Eat, Play",
      eyebrow: "Experience",
      ...
      icon: Gamepad2,
      bg: `linear-gradient(160deg,rgba(${t.accentSoft},0.62),rgba(255,255,255,0.92))`,
      iconBg: `rgb(${t.accentSoft})`,
    },
    {
      ...
      icon: MessagesSquare,
      bg: `linear-gradient(180deg,rgba(255,255,255,0.94),rgba(${t.brandSoft},0.3))`,
      iconBg: `rgb(${t.brandSoft})`,
    },
    {
      title: "Social Media",
      ...
      icon: Share2,
      bg: `linear-gradient(180deg,rgba(255,255,255,0.94),rgba(${t.accentSoft},0.34))`,
      iconBg: `rgb(${t.accentSoft})`,
    },
  ] as const;
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mx-auto max-w-[420px] rounded-[32px] border-[6px] border-slate-900 bg-white shadow-2xl overflow-hidden">
        ...
        <div
          className="p-3 pb-6 grid grid-cols-2 gap-3"
          style={{
            background: `linear-gradient(180deg,rgba(${t.pageBackgroundFrom},0.5),rgba(${t.pageBackgroundTo},0.5))`,
          }}
        >
          {cards.map((card) => (
            <FeatureCard
              ...
              bg={card.bg}
              iconBg={card.iconBg}
              brandColor={rgb(t.brandColor)}
              cardBorder={t.cardBorder}
              cardSurface={t.cardSurface}
              border={t.border}
              muted={rgb(t.muted || t.ink)}
            />
          ))}
        </div>
      </div>
