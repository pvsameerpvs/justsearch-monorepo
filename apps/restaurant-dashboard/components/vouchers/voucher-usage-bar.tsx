interface VoucherUsageBarProps {
  usageCount: number;
  usageLimit: number;
}

export function VoucherUsageBar({ usageCount, usageLimit }: VoucherUsageBarProps) {
  ...
  return (
    <div className="space-y-1">
      <div className="flex items-center justify-between text-[10px]">
        <span className={`font-bold ${isFull ? "text-red-600" : "text-slate-500"}`}>
