...
export function OrderError({ message, onRetry }: OrderErrorProps) {
  return (
    <div className="flex flex-col items-center gap-3 rounded-2xl border border-red-200 bg-red-50 py-12">
      ...
      <button onClick={onRetry} className="flex items-center gap-2 rounded-xl bg-white px-4 py-2 text-sm font-semibold text-red-600 border border-red-200 hover:bg-red-100">
